...
void main() {
  ...
  group('Core Components Tests', () {
    testWidgets('SoteriaButton primary renders label and handles tap', (WidgetTester tester) async {
      bool tapped = false;
    ...
    testWidgets('SoteriaBadge displays label', (WidgetTester tester) async {
      await tester.pumpWidget(
        wrap(const SoteriaBadge(label: 'Active')),
      );

      expect(find.text('ACTIVE'), findsOneWidget);
    });

    testWidgets('SoteriaText variants use correct styles', (WidgetTester tester) async {
      await tester.pumpWidget(
        wrap(const SoteriaText.displayLarge('Big Text')),
      );
