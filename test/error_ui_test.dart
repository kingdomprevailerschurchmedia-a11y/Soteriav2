...
void main() {
  ...
  testWidgets('PremiumErrorScreen displays network error details', (tester) async {
  ...
  testWidgets('PremiumErrorScreen displays system anomaly for unexpected errors', (tester) async {
    tester.view.physicalSize = const Size(390 * 3, 844 * 3);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
  ...
  testWidgets('PremiumErrorScreen shows retry button when onRetry is provided', (tester) async {
    tester.view.physicalSize = const Size(390 * 3, 844 * 3);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
