...
void main() {
  runApp(const LandscapeProfilePreview());
}

class LandscapeProfilePreview extends StatelessWidget {
  const LandscapeProfilePreview({super.key});

  @override
  Widget build(BuildContext context) {
    return PreviewScaffold(
      designSize: PreviewDevices.ipadProLandscape,
      overrides: [
