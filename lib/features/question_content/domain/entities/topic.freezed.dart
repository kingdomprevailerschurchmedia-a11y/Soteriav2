...
mixin _$Topic {
 ...
 String get id; String get subcategoryId; String get name; String get description; String get slug; int get displayOrder; bool get active; Map<String, dynamic> get metadata; DateTime? get createdAt; DateTime? get updatedAt;
...
@override
String toString() {
  return 'Topic(id: $id, subcategoryId: $subcategoryId, name: $name, description: $description, slug: $slug, displayOrder: $displayOrder, active: $active, metadata: $metadata, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String subcategoryId, String name, String description, String slug, int displayOrder, bool active, Map<String, dynamic> metadata, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String subcategoryId,  String name,  String description,  String slug,  int displayOrder,  bool active,  Map<String, dynamic> metadata,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Topic() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String subcategoryId,  String name,  String description,  String slug,  int displayOrder,  bool active,  Map<String, dynamic> metadata,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Topic():
return $default(_that.id,_that.subcategoryId,_that.name,_that.description,_that.slug,_that.displayOrder,_that.active,_that.metadata,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String subcategoryId,  String name,  String description,  String slug,  int displayOrder,  bool active,  Map<String, dynamic> metadata,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Topic() when $default != null:
return $default(_that.id,_that.subcategoryId,_that.name,_that.description,_that.slug,_that.displayOrder,_that.active,_that.metadata,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Topic implements Topic {
  const _Topic({required this.id, required this.subcategoryId, required this.name, required this.description, required this.slug, this.displayOrder = 0, this.active = true, final  Map<String, dynamic> metadata = const {}, this.createdAt, this.updatedAt}): _metadata = metadata;
