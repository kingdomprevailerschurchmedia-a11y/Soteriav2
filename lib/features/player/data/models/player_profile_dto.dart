...
class PlayerProfileDto {
  static PlayerProfile fromFirestore(DocumentSnapshot doc) {
    ...
    return PlayerProfile(
      ...
      withdrawableCoins: (data['withdrawableCoins'] as num?)?.toInt() ?? 0,
      lastCoinTransactionId: data['lastCoinTransactionId'] as String?,
      lastXpTransactionId: data['lastXpTransactionId'] as String?,
      lastRankTransactionId: data['lastRankTransactionId'] as String?,
      currentStreak: (data['currentStreak'] as num?)?.toInt() ?? 0,
      highestStreak: (data['highestStreak'] as num?)?.toInt() ?? 0,
      lastStreakMilestoneCelebrated: (data['lastStreakMilestoneCelebrated'] as num?)?.toInt() ?? 0,
      ...
      allowVersusChallenges: data['allowVersusChallenges'] as bool? ?? true,
  ...
  static Map<String, dynamic> toFirestore(PlayerProfile profile) {
    return {
      ...
      'xp': profile.xp,
      'coins': profile.coins,
      'withdrawableCoins': profile.withdrawableCoins,
      'lastCoinTransactionId': profile.lastCoinTransactionId,
      'lastXpTransactionId': profile.lastXpTransactionId,
      'lastRankTransactionId': profile.lastRankTransactionId,
      'currentStreak': profile.currentStreak,
      'highestStreak': profile.highestStreak,
      'lastStreakMilestoneCelebrated': profile.lastStreakMilestoneCelebrated,
      ...
      'allowVersusChallenges': profile.allowVersusChallenges,
      'role': profile.role,
