...
final competitiveInsightsProvider = FutureProvider<CompetitiveInsights>((ref) async {
  final history = await ref.watch(matchHistoryProvider.future);
  return ref.read(competitiveInsightsServiceProvider).calculateInsights(history);
});

final questionRepositoryProvider = Provider<QuestionRepository>((ref) {
  return QuestionRepositoryImpl(
    remoteSource: FirestoreQuestionDataSource(ref.watch(firestoreProvider)),
  );
});
