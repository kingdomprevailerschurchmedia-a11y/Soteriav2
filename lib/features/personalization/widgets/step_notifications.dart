...
class StepNotifications extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        Text('Notification Preferences', style: context.headlineMedium),
            ...
            child: GlassSurface(
              child: Material(
                ...
                child: SwitchListTile(
                  ...
                  onChanged: (val) =>
                      notifier.updateNotificationPref(pref['key']!, val),
                  ...
                  inactiveTrackColor: SoteriaColors.muted.withValues(
                    alpha: 0.2,
                  ),
